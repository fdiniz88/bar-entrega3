...
<div class="container"  style="    left: 250px;    top: 200px;    position: relative;">
  ...
  <form class="form-inline" action="/login" method="post">
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" id="login" placeholder="Digitar login" name="login">
    <label for="pwd2" class="mb-2 mr-sm-2">Senha:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" id="senha" placeholder="Digitar senha" name="senha">
